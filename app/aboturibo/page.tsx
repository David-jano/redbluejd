          ...
          <div className="relative w-full max-w-6xl">
            ...
            <div className="bg-black rounded-lg overflow-hidden shadow-2xl">
              {videoError ? (
                <div className="bg-gray-900 flex flex-col items-center justify-center text-white p-8 min-h-[400px]">
                  ...
                  <p className="text-sm text-gray-400 text-center">Make sure us_doc.mp4 exists in the /public/videos/ folder</p>
                  <button 
                    onClick={handleCloseVideo}
                ...
                >
                  ...
                  <p className="text-white p-4">
                    Your browser doesn't support video. Please try a different browser.
                  </p>
                </video>
              )}
            </div>
            ...
            {!videoError && (
              <div className="mt-4 text-white text-center">
                <p className="text-lg font-semibold">US Documentary - Our Story</p>
              </div>
            )}
          </div>
        </div>
